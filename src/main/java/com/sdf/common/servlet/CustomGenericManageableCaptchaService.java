...
/**
 * 解决Invalid ID, could not validate unexisting or already validated captcha
 * 
 * @author SDF
 * @date 2016年12月13日
 */
public class CustomGenericManageableCaptchaService extends GenericManageableCaptchaService {
	 ...
	 * @param captchaStoreLoadBeforeGarbageCollection
	 */
	public CustomGenericManageableCaptchaService(CaptchaStore captchaStore, CaptchaEngine captchaEngine,
	 ...
	 * 最后就是在你的业务逻辑里面手动调用removeCapthca()方法了
	 * 
	 * @param sessionId
