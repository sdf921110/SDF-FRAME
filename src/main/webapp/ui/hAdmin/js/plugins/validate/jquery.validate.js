 ...
 * 
 * 修改时间：2016年10月7日11:21:26 作者：SDF
 */
			...
			.extend(
					c.validator,
					{
						...
						messages : {
							...
							remote : icon + "请修正该字段.",
							email : icon + "输入的邮箱格式不正确.",
							phone : icon + "手机号码输入不正确.",
							idcard : icon + "身份证格式不正确.",
							url : icon + "请输入合法的URL地址.",
							date : icon + "请输入合法的日期.",
							dateISO : icon + "请输入合法的日期 (ISO格式).",
							number : icon + "请输入数值.",
							digits : icon + "只能输入正整数.",
							creditcard : icon + "请输入合法的信用卡号",
							equalTo : icon + "请再次输入相同的值.",
							accept : icon + "请输入拥有合法后缀名的字符串.",
							maxlength : c.validator.format(icon
									+ "长度不能大于 {0} 个字符."),
							minlength : c.validator.format(icon
									+ "长度不能小于 {0} 个字符."),
							rangelength : c.validator.format(icon
									+ "请输入一个长度介于 {0} 和 {1} 之间的字符串."),
							range : c.validator.format(icon
									+ "请输入一个介于 {0} 和 {1} 之间的值."),
							max : c.validator.format(icon + "请输入一个最大为 {0} 的值."),
							min : c.validator.format(icon + "请输入一个最小为 {0} 的值.")
						},
