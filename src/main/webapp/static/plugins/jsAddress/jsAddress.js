...
{name:'台湾', cityList:[		   
{name:'台北市', areaList:['市辖区','内湖区','南港区','中正区','万华区','大同区','中山区','松山区','大安区','信义区','文山区','士林区','北投区']},		   
{name:'新北市', areaList:['市辖区','板桥区','汐止区','新店区','永和区','中和区','土城区','树林区','三重区','新庄区','芦洲区','瑞芳区','三峡区','莺歌区','淡水区','万里区','金山区','深坑区','石碇区','平溪区','双溪区','贡寮区','坪林区','乌来区','泰山区','林口区','五股区','八里区','三芝区','石门区']},		   
{name:'桃园市', areaList:['市辖区','桃园区','中坜区','平镇区','八德区','杨梅区','芦竹区','大溪区','龙潭区','龟山区','大园区','观音区','新屋区','复兴区']},		   
{name:'台中市', areaList:['市辖区','中区','东区','南区','西区','北区','北屯区','西屯区','南屯区','太平区','大里区','雾峰区','乌日区','丰原区','后里区','潭子区','大雅区','神冈区','石冈区','东势区','新社区','和平区','大肚区','沙鹿区','龙井区','梧栖区','清水区','大甲区','外埔区','大安区']},		   
{name:'台南市', areaList:['市辖区','中西区','东区','南区','北区','安平区','安南区','永康区','归仁区','新化区','左镇区','玉井区','楠西区','南化区','仁德区','关庙区','龙崎区','官田区','麻豆区','佳里区','西港区','七股区','将军区','学甲区','北门区','新营区','后壁区','白河区','东山区','六甲区','下营区','柳营区','盐水区','善化区','大内区','山上区','新市区','安定区']},		   
{name:'高雄市', areaList:['市辖区','楠梓区','左营区','鼓山区','三民区','盐埕区','前金区','新兴区','苓雅区','前镇区','旗津区','小港区','凤山区','大寮区','鸟松区','林园区','仁武区','大树区','大社区','冈山区','路竹区','桥头区','梓官区','弥陀区','永安区','燕巢区','阿莲区','茄萣区','湖内区','旗山区','美浓区','内门区','杉林区','甲仙区','六龟区','茂林区','桃源区','那玛夏区']},		   
{name:'基隆市', areaList:['市辖区','中正区','信义区','仁爱区','中山区','安乐区','暖暖区','七堵区']},		   
