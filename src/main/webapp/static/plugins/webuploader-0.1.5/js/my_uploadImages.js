(function ($) {
    ...
    $(function () {
        ...
        uploader = WebUploader.create({
            ...
            // swf : '../Uploader.swf',
            swf: contextPath
            + '/static/plugins/webuploader-0.1.5/Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: contextPath + '/upload/addWebUploaderImg?',
...
var dataTable = parent.dataTable;// parent.dataTable：父页面 dataTable
