...
var myValidator = {
	 ...
	 * 
	 * @param input
	 * @param withEnglishCharacter
	 * @param withNumber
	 * @param withChineseCharacter
	 * @returns {Boolean}
	 */
	...
	/**
	 * 验证固定电话号码 [3位或4位区号；区号可以用小括号括起来；区号可以省略；
	 * 区号与本地号间可以用减号或空格隔开；可以有3位数的分机号，分机号前要加减号]
	 * 
	 * @param input
	 * @returns {Boolean}
	 */
	...
	/**
	 * 验证手机号码 [可匹配"(+86)013325656352"，括号可以省略，+号可以省略，
	 * (+86)可以省略，11位手机号前的0可以省略；11位手机号第二位数可以是3、4、5、8中的任意一个]
	 * 
	 * @param input
	 * @returns {Boolean}
	 */
	...
	/**
	 * 验证电子邮箱 [@字符前可以包含字母、数字、下划线和点号；@字符后可以包含字母、数字、下划线和点号；
	 * 
