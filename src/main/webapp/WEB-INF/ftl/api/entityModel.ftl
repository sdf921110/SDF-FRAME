package ${packageNamePrefix}.pojo;
...
public class ${className} extends BasePO {
	...
	<#if pro.proName == "id" || pro.proName == "createTime" || pro.proName == "createUser" || pro.proName == "updateTime" || pro.proName == "updateUser" || pro.proName == "status">  
	<#else>  
	/**${pro.fieldDesc}**/	
